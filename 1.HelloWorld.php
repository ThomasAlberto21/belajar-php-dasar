...
// Todo Membuat program pertama
// * File kode program PHP diakhiri dengan extention .php
// * Di awal kode program PHP, wajib menambahkan <?php. Dan diakhir kode program php perlu ditambahkan tanda tanya dan tanda lebih dari (tidak diwajibkan)
